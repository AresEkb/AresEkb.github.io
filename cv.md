...
I developed a translator from UML models with OCL expressions to XSLT or Java code with XPath expressions. I participated as a system analyst in the development of the entire system, wrote technical documentation, assigned tasks for developers.
